...
public static class LetterNotation
{
    ...
    static string GetTier1Root(long value, int mode = 0)
    {
        ...
        */
        ...
        string[] onesRoot = { "", "M", "B", "T", "Qu", "Qi", "Se", "Sp", "Oc", "No" };
        string[] tensRoot = { "", "De", "Vi", "Tr", "Qd", "Qq", "Sg", "St", "Og", "Ng" };
        string[] hundredRoot = { "", "Ce", "Dc", "Tc", "Qdc", "Qic", "Sc", "Spc", "Ocg", "Nog" };
        ...
        if (mode == 2)
        {
            onesRoot = new string[] { "", "Un", "Du", "Te", "Qu", "Qi", "Se", "Sp", "Oc", "No" };
        }
    ...
    static string GetTier2Root(long value) {
        string[] prefixes = { "", "Mi", "Mc", "Na", "Pi", "Fe", "At", "Ze" };
