...
public static class WordNotation
{
    ...
    static string GetTier1Root(long value, int mode = 0)
    {
        ...
        */
        ...
        string[] onesRoot = { "", "m", "b", "tr", "quadr", "quint", "sext", "sept", "oct", "non" };
        string[] tensRoot = { "", "dec", "vigint", "trigint", "quadragint", "quinquagint", "sexagint", "septuagint", "octogint", "nonagint" };
        string[] hundredRoot = { "", "cen", "ducen", "trecen", "quadringen", "quingen", "sescen", "septingen", "octingen", "nongen" };
        ...
        if (mode == 2)
        {
            onesRoot = new string[] { "", "un", "duo", "tre", "quattour", "quin", "sex", "septen", "octo", "novem" };
        }
        ...
        onesRoot = new string[]{ "", "un", "doe", "tre", "quattour", "quin", "sex", "septen", "octo", "novem" };
